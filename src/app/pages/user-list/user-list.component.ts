...
export class UserListComponent {
  ...
  getUsers() {
    this.userService.searchUsers(this.model.division, this.model.thana, this.model.bloodGroup, '', this.model.postBy, this.model.from, this.model.to).subscribe(data => {
      this.users = data;
    });
  }
  ...
  onSearch() {
    this.userService.getAllUsers(this.model.searchQuery.trim()).subscribe(data => {
      this.users = data;
    });
  }
